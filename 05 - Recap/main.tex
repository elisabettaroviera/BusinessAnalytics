...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PDF 5 %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-1cm}
\textcolor{Teal}{\section{CAP 5 -- Schedulazione nella produzione e nei servizi}}
\paragraph{Recap}
...
\item Cap 3 pag 12/46 politica s periodic review
\end{itemize}
