...
\paragraph{Recap}
Le decisioni di business avvengono spesso in presenza di \textcolor{NavyBlue}{\textbf{incertezza}} e non possono essere ricondotte alla sola costruzione di una previsione puntuale. La distinzione tra \textcolor{NavyBlue}{\textbf{Business Analytics descrittiva, predittiva e prescrittiva}} chiarisce che l’obiettivo finale non è prevedere una variabile aleatoria, ma \textbf{supportare una decisione}, tenendo conto delle conseguenze economiche delle scelte.

Una previsione è sempre legata a una \textcolor{NavyBlue}{\textbf{funzione di perdita}}: il valore “migliore” dipende da come vengono penalizzati gli errori. Il valore atteso è ottimale solo in presenza di penalità simmetriche; in generale, \textbf{errori di segno opposto possono avere impatti diversi} e portare a decisioni ottimali basate su mediane o quantili. Non esiste quindi una previsione universalmente corretta, ma solo previsioni \textbf{coerenti con il criterio decisionale}.

Nei modelli decisionali l’attenzione si sposta dalla previsione alla \textcolor{NavyBlue}{\textbf{scelta di un vettore di decisioni}} sotto incertezza. Se i fattori di rischio non sono probabilisticamente modellabili si ottiene un approccio \textcolor{NavyBlue}{\textbf{robusto}}; se invece sono descritti da una distribuzione nota si ottiene un \textcolor{NavyBlue}{\textbf{problema di ottimizzazione stocastica}}. In entrambi i casi, sostituire l’incertezza con il valore medio può produrre decisioni fortemente subottimali.

Il modello del \textcolor{NavyBlue}{\textbf{newsvendor}} mostra in modo esplicito come la decisione ottimale derivi dal bilanciamento tra \textbf{costo di sottostima} e \textbf{costo di sovrastima}, e non dalla domanda media. Questo esempio evidenzia che l’incertezza entra direttamente nella struttura economica del problema.

I \textcolor{NavyBlue}{\textbf{vincoli probabilistici}} permettono di imporre il rispetto dei vincoli solo con una certa probabilità, ma possono generare insiemi ammissibili non convessi e problemi computazionalmente difficili. Gli \textcolor{NavyBlue}{\textbf{alberi di decisione}} consentono invece di rappresentare decisioni \textbf{adattive}, distinguendo chiaramente tra scelte e realizzazioni casuali e risolvendo il problema tramite \textcolor{NavyBlue}{\textbf{backward induction}}.

Il valore dell’informazione viene quantificato tramite \textcolor{NavyBlue}{\textbf{EVPI}} e \textcolor{NavyBlue}{\textbf{VSS}}, che misurano rispettivamente il beneficio dell’informazione perfetta e il guadagno ottenuto risolvendo il modello stocastico rispetto a una soluzione deterministica a valore atteso. Valori elevati indicano che modellare esplicitamente l’incertezza è essenziale.

L’introduzione ai \textcolor{NavyBlue}{\textbf{modelli a due stadi con ricorso}} chiarisce la distinzione tra decisioni \textcolor{NavyBlue}{\textbf{here-and-now}} e decisioni \textcolor{NavyBlue}{\textbf{wait-and-see}}, mostrando come l’adattamento delle decisioni dopo l’osservazione dell’incertezza migliori la qualità delle soluzioni. Questo costituisce la base per l’estensione ai modelli multistadio e ai temi di generazione degli scenari e stabilità delle soluzioni.
